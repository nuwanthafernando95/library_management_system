...
public class Program {
    ...
    public void destributeProgram() {
        try {
            DBConnect.updateDB("UPDATE program SET status = '" + AppStrings.PENDING + "' WHERE id = '" + this.id + "'");
    ...
    public void activeProgram() {
        try {
            DBConnect.updateDB("UPDATE program SET status = '" + AppStrings.ACTIVE + "' WHERE id = '" + this.id + "'");
